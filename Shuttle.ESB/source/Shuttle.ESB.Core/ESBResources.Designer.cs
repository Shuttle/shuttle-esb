...
namespace Shuttle.ESB.Core {
    ...
    public class ESBResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to A queue factory for scheme &apos;{0}&apos; already exists.  Cannot register queue factory type &apos;{1}&apos;..
        /// </summary>
        public static string DuplicateQueueFactoryException {
            get {
                return ResourceManager.GetString("DuplicateQueueFactoryException", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Type type &apos;{0}&apos; is not registered with the serializer so it cannot be serialized.  Please use [SerialierInstance].AddKnownType to add the type before attempting to serialize or deserialize a TransportMessage containing this type in the object graph of the message property..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Transport message with id &apos;{0}&apos; will be ignored until &apos;{1}&apos;..
        /// </summary>

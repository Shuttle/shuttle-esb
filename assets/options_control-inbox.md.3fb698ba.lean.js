...
const __pageData = JSON.parse('{"title":"Control Inbox Options","description":"","frontmatter":{},"headers":[{"level":2,"title":"Options","slug":"options","link":"#options","children":[]}],"relativePath":"options/control-inbox.md"}');
const _sfc_main = { name: "options/control-inbox.md" };

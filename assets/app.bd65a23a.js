...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.360c9c18.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
      if (!theme.algolia) {

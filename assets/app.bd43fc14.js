...
const _withScopeId$7 = (n) => (pushScopeId("data-v-4873ef2c"), n = n(), popScopeId(), n);
...
var VPNavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-4873ef2c"]]);
var style = "";
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.ae9ac1b8.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {

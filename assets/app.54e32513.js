...
const _withScopeId$7 = (n) => (pushScopeId("data-v-048b1648"), n = n(), popScopeId(), n);
...
const _sfc_main$x = {
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a2;
      return openBlock(), createElementBlock(Fragment, null, [
        createTextVNode(" >>>" + toDisplayString(unref(site).base) + " ", 1),
        createBaseVNode("a", {
          class: "VPNavBarTitle",
...
var VPNavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-048b1648"]]);
var style = "";
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.b377950f.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
...
export { Fragment as F, VTIconShuttle as V, _export_sfc as _, createStaticVNode as a, createBaseVNode as b, createElementBlock as c, createApp, createTextVNode as d, createVNode as e, popScopeId as f, defineComponent as g, useData as h, useRoute as i, useRouter as j, onMounted as k, openBlock as o, pushScopeId as p, toDisplayString as t, unref as u };

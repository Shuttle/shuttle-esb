...
const __pageData = JSON.parse('{"title":"Service Bus Options","description":"","frontmatter":{},"headers":[{"level":2,"title":"Options","slug":"options","link":"#options","children":[]}],"relativePath":"options/servicebus.md"}');
const _sfc_main = { name: "options/servicebus.md" };

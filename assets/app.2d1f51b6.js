...
var serializedSiteData = '{"lang":"en-US","title":"Shuttle.Esb","description":"Shuttle.Esb Documentation","base":"/shuttle-esb/","head":[],"themeConfig":{"algolia":{"indexName":"shuttle-esb","appId":"VM33RJ87BH","apiKey":"fc560606a3c14b173d0ddf57a3258c84"},"socialLinks":[{"icon":"github","link":"https://github.com/Shuttle/shuttle-esb"}],"footer":{"copyright":"Copyright \xA9 2013-2022 Eben Roux"},"nav":[{"text":"Concepts","activeMatch":"^/concepts/","link":"/concepts/why"},{"text":"Guide","activeMatch":"^/guide/","link":"/guide/introduction"},{"text":"Configuration","activeMatch":"^/configuration/","link":"/configuration/full"},{"text":"Components","activeMatch":"^/components/","link":"/components/overview"},{"text":"Implementations","activeMatch":"^/implementations/","link":"/implementations/overview"},{"text":"Modules","activeMatch":"^/modules/","link":"/modules/overview"}],"sidebar":{"/concepts/":[{"text":"Concepts","items":[{"text":"Why?","link":"/concepts/why"},{"text":"Autonomous Business Components","link":"/concepts/autonomous-business-components"}]},{"text":"Patterns","items":[{"text":"Request / Response","link":"/concepts/patterns/request-response"},{"text":"Publish / Subscribe","link":"/concepts/patterns/publish-subscribe"},{"text":"Message Distribution","link":"/concepts/patterns/message-distribution"},{"text":"Message Idempotence","link":"/concepts/patterns/message-idempotence"},{"text":"Deferred Messages","link":"/concepts/patterns/deferred-messages"},{"text":"Message Routing","link":"/concepts/patterns/message-routing"}]},{"text":"Essentials","items":[{"text":"Bounded Contexts","link":"/concepts/essentials/bounded-contexts"}]}],"/guide/":[{"text":"Overview","items":[{"text":"Introduction","link":"/guide/introduction"},{"text":"Getting Started","link":"/guide/getting-started"}]},{"text":"Patterns","items":[{"text":"Request / Response","link":"/guide/patterns/request-response"},{"text":"Publish / Subscribe","link":"/guide/patterns/publish-subscribe"},{"text":"Deferred Messages","link":"/guide/patterns/deferred-messages"},{"text":"Dependency Injection","link":"/guide/patterns/dependency-injection"},{"text":"Message Distribution","link":"/guide/patterns/message-distribution"},{"text":"Message Idempotence","link":"/guide/patterns/message-idempotence"},{"text":"Process Management","link":"/guide/patterns/process-management"}]},{"text":"Essentials","items":[{"text":"Exception Handling","link":"/guide/essentials/exception-handling"}]}],"/components/":[{"text":"Implementations","items":[{"text":"Idempotence Service","link":"/components/idempotence-service"},{"text":"Identity Provider","link":"/components/identity-provider"},{"text":"Message Handler Invoker","link":"/components/message-handler-invoker"},{"text":"Message Handler","link":"/components/message-handler"},{"text":"Message Handling Assessor","link":"/components/message-handling-assessor"},{"text":"Message Route Provider","link":"/components/message-route-provider"},{"text":"Message Sender","link":"/components/message-sender"},{"text":"Queue Manager","link":"/components/queue-manager"},{"text":"Policy","link":"/components/service-bus-policy"},{"text":"Subscription Manager","link":"/components/subscription-manager"},{"text":"Transport Message","link":"/components/transport-message"},{"text":"Transport Message Configurator","link":"/components/transport-message-configurator"},{"text":"Transport Header","link":"/components/transport-header"}]}],"/implementations/":[{"text":"Queue","items":[{"text":"Amazon SQS","link":"/implementations/queue/amazonsqs"},{"text":"Azure Storage Queues","link":"/implementations/queue/azuremq"},{"text":"File","link":"/implementations/queue/filemq"},{"text":"MSMQ","link":"/implementations/queue/msmq"},{"text":"RabbitMQ","link":"/implementations/queue/rabbitmq"},{"text":"SQL","link":"/implementations/queue/sql"}]},{"text":"Subscription","items":[{"text":"SQL","link":"/implementations/subscription/sql"}]},{"text":"Idempotence","items":[{"text":"SQL","link":"/implementations/idempotence/sql"}]}],"/modules/":[{"text":"Implementations","items":[{"text":"Active Time Range","link":"/modules/active-time-range"},{"text":"Corrupt Transport Message","link":"/modules/corrupt-transport-message"},{"text":"Message Forwarding","link":"/modules/message-forwarding"},{"text":"Purge Inbox","link":"/modules/purge-inbox"},{"text":"Purge Queues","link":"/modules/purge-queues"},{"text":"Throttle (Windows)","link":"/modules/throttle"}]}]}},"locales":{},"langs":{},"scrollOffset":90}';
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => import("./chunks/VPAlgoliaSearchBox.dba73f7c.js"));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
...
export { Fragment as F, VTIconShuttle as V, _export_sfc as _, createStaticVNode as a, createBaseVNode as b, createElementBlock as c, createApp, createTextVNode as d, createVNode as e, defineComponent as f, useData as g, useRoute as h, useRouter as i, onMounted as j, openBlock as o, toDisplayString as t, unref as u };

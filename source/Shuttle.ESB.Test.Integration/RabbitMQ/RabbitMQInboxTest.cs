...
namespace Shuttle.ESB.Test.Integration
{
	public class RabbitMQInboxTest : InboxFixture
	{
		...
		{
			TestInboxError("rabbitmq://shuttle:shuttle!@localhost", false, isTransactionalEndpoint);
		}
		...
		{
			TestInboxConcurrency("rabbitmq://shuttle:shuttle!@localhost", msToComplete, false, isTransactionalEndpoint);
		}
		...
		{
			TestInboxThroughput("rabbitmq://shuttle:shuttle!@localhost", 1000, count, useIdempotenceTracker, false, isTransactionalEndpoint);
		}
